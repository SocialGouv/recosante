...
export default function Element(props) {
  ...
  return props?.label ? (
    <Wrapper>
      <Title>
        {props?.url ? (
          <StyledMagicLink to={props.url}>{props.label}</StyledMagicLink>
        ) : (
          props.label
        )}
      </Title>
      {props?.sample && (
        <Sample value={value}>
          ...
          {props.sample.date && (
            <>
               <Date>(prélèvement du {props.sample.date})</Date>
            </>
          )}
        </Sample>
      )}
      {["Excellent", "Bon", "Suffisant", "Insuffisant"].includes(
        ...
        <Ranking label={props.ranking.label}>
          ...
          {props.ranking.year && (
            <>
               <Year>(classement de {props.ranking.year})</Year>
            </>
          )}
        </Ranking>
      )}
        ...
        <Interdiction>
          <div>
            ...
            {props.interdiction.date && (
              <>
                 <Date>({props.interdiction.date})</Date>
              </>
            )}
          </div>
        </Interdiction>
