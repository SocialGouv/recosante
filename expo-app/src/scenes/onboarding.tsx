    ...
    <SafeAreaView className="flex flex-1 bg-app-100">
      <OnboardingStack.Navigator screenOptions={{ headerShown: false }}>
        <OnboardingStack.Screen
          name="ONBOARDINSCREEN_1"
          component={OnboardinScreen1}
        />
        <OnboardingStack.Screen
          name="ONBOARDINSCREEN_2"
          component={OnboardinScreen2}
        />
        <OnboardingStack.Screen
          name="ONBOARDINSCREEN_3"
          component={OnboardinScreen3}
        />
        <OnboardingStack.Screen
          name="ONBOARDINSCREEN_4"
          component={OnboardinScreen4}
        />
...
function OnboardinScreen1({ navigation }: { navigation: any }) {
  return (
...
function OnboardinScreen2({ navigation }: { navigation: any }) {
  return (
    <View className="flex flex-1 items-center justify-around bg-app-100">
      <MyText font="MarianneExtraBold" className="text-center text-3xl">
...
function OnboardinScreen3({ navigation }: { navigation: any }) {
  return (
    <View className="flex flex-1 items-center justify-around bg-app-100">
      <MyText font="MarianneExtraBold" className="text-center text-3xl">
...
function OnboardinScreen4({ navigation }: { navigation: any }) {
  return (
    <View className="flex flex-1 items-center justify-around bg-app-100">
      <MyText font="MarianneExtraBold" className="text-center text-3xl">
