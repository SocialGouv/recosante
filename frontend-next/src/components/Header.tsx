...
function Marianne() {
  return (
    <Wrapper>
      <Text width="73" height="26" viewBox="0 0 73 26" aria-hidden="true">
        <path
...
export function Header() {
  ...
  const handleMunicipalitySelect = (municipality: Municipality) => {
    ...
    // Redirection vers la page d'accueil avec les paramètres de la commune
    router.push(`/?code=${municipality.code}&nom=${encodeURIComponent(municipality.nom)}`);
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (results.length > 0) {
      handleMunicipalitySelect(results[0]);
    }
  };
    ...
    <header className="bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          {/* Logos à gauche - cliquables pour revenir à l'accueil */}
            ...
            <div className="relative">
              <form onSubmit={handleSubmit}>
                <input
                  ...
                  className="w-64 px-4 py-2 border-b-2 border-main focus:outline-none focus:border-main/80 bg-transparent text-gray-700"
                  value={query}
            ...
            <div className="relative">
              <form onSubmit={handleSubmit}>
                <input
                  type="text"
                  placeholder="Entrez une ville"
                  className="w-full px-4 py-2 border-b-2 border-main focus:outline-none focus:border-main/80 bg-transparent text-gray-700"
                  value={query}
                  onChange={handleInputChange}
                  onFocus={handleInputFocus}
                  onBlur={handleInputBlur}
