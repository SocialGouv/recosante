    ...
    def attributes(self):
        ...
        return {
            ...
            **{
                ...
                "VIGILANCE_VALIDITE_DEBUT": VigilanceMeteo.make_start_date([self.vigilance_globale], self.vigilance_globale.validity.lower.strftime).strftime('%d/%m/%Y à %H:%M') if self.vigilance_globale else "",
                "VIGILANCE_VALIDITE_FIN": VigilanceMeteo.make_end_date([self.vigilance_globale], self.vigilance_globale.validity.upper.strftime).strftime('%d/%m/%Y à %H:%M') if self.vigilance_globale else "",
