...
def upgrade():
    ...
    op.add_column('epci', sa.Column('created_at', sa.DateTime(),
                  nullable=True), schema='indice_schema')
    op.add_column('epci', sa.Column('updated_at', sa.DateTime(),
                  nullable=True), schema='indice_schema')
    op.add_column('episode_pollution', sa.Column(
        'created_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('episode_pollution', sa.Column(
        'updated_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('indiceATMO', sa.Column(
        'created_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('indiceATMO', sa.Column(
        'updated_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('indice_uv', sa.Column(
        'created_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('indice_uv', sa.Column(
        'updated_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('potentiel_radon', sa.Column(
        'created_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('potentiel_radon', sa.Column(
        'updated_at', sa.DateTime(), nullable=True), schema='indice_schema')
    op.add_column('raep', sa.Column('created_at', sa.DateTime(),
                  nullable=True), schema='indice_schema')
    op.add_column('raep', sa.Column('updated_at', sa.DateTime(),
                  nullable=True), schema='indice_schema')
